...
public class GUI_ViewTransaction extends javax.swing.JFrame {

    public GUI_ViewTransaction() {
        initComponents();
    ...
    private void loadTransactionData() {
        DefaultTableModel model = (DefaultTableModel) TransR_tb_TransactionRecord.getModel();
        model.setRowCount(0);
    ...
    private void initComponents() {
        ...
        TransR_tb_TransactionRecord = new javax.swing.JTable();
        ...
        TransR_tb_TransactionRecord.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        TransR_tb_TransactionRecord.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        TransR_tb_TransactionRecord.setDefaultEditor(Object.class, null);
        jScrollPane1.setViewportView(TransR_tb_TransactionRecord);

        TranR_Home.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 720, 300));
        ...
        TranR_DateFilter.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 720, 300));
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(720, 100));
        jPanel1.setPreferredSize(new java.awt.Dimension(800, 100));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel4.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("View Transaction");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(292, 10, 215, 30));
    ...
    private javax.swing.JTable TransR_tb_TransactionRecord;
